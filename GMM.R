# ===============================================
# Customer Segmentation using GMM (EM Algorithm)
# ===============================================
...
customer2 <- matrix(
  c(
    rnorm(50, mean = 45, sd = 5),
    rnorm(50, mean = 70000, sd = 5000)
  ),
  nrow = 50,
  ncol = 2,
)

X <- rbind(customer1, customer2)

colnames(X) <- c("Age", "Income")
...
plot(
  ...
  xlab = "Age",
  ylab = "Annual Income",
  main = "Customer Segmentation using GMM (EM Algorithm)"
)
